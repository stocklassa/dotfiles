...
vim.keymap.set('n', '<Leader>VV', ':e /home/eric/dotfiles/nvim/.config/nvim/lua/eric/remap.lua<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<Leader>VP', ':e /home/eric/dotfiles/nvim/.config/nvim/lua/plugins/init.lua<CR>', { noremap = true, silent = false })
vim.keymap.set('n', '<Leader>v', '[[<Cmd>source /home/eric/dotfiles/nvim/.config/nvim/lua/eric/remap.lua<CR>]]', { noremap = true, silent = false })
